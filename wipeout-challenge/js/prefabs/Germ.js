...
// TODO allow texture to be set based on spritesheet

Wipeout.Germ = function(state, x, y, data){
...
Wipeout.Germ.prototype = Object.create(Phaser.Sprite.prototype);
Wipeout.Germ.prototype.constructor = Wipeout.Germ;

Wipeout.Germ.prototype.reset = function(x, y, data) {
...
Wipeout.Germ.prototype.damage = function(amount) {
